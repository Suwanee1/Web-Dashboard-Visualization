...
new_df = df.groupby(['Country']).agg({'Confirmed': 'sum', 'Deaths': 'sum', 'Recovered': 'sum', 'Unrecovered': 'sum'}).reset_index()
...
layout = go.Layout(title='Corona Virus Cases in the first 20 countries except China', xaxis_title="Country", yaxis_title="Number of cases", barmode='stack')
